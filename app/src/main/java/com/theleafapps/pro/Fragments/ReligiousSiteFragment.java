 ...
 */
public class ReligiousSiteFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        List<Element> religiousSitesElements = TourGuideDataHelper.getReligiousSites();

        // Create an {@link WordAdapter}, whose data source is a list of {@link Word}s. The
        // adapter knows how to create list items for each item in the list.
        ElementAdapter wordAdapter = new ElementAdapter(getActivity(), religiousSitesElements);
